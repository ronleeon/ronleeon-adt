#ifndef COMPHSICS_ADT_B-_TREE_H
#define COMPHSICS_ADT_B-_TREE_H
...
namespace comphsics{
	namespace tree{
		...
		// will be ignored.
		template<typename DataType,typename Compare=std::less<DataType>,typename NodeType=node::B_node<DataType>>
		class B_tree:public b_tree<DataType,NodeType>{
