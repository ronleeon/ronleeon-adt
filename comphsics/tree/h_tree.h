#ifndef COMPHSICS_ADT_H_TREE_H
#define COMPHSICS_ADT_H_TREE_H
...
namespace comphsics{
	namespace tree{
		...
		class h_tree:public b_tree<DataType,NodeType>{
		...
		private:
			...
			explicit h_tree(node_pointer t)
				:b_tree<DataType,NodeType>(t){}
			explicit h_tree(std::nullptr_t):b_tree<DataType,NodeType>(nullptr){}
		...
		public:
			...
			h_tree(h_tree && tree):b_tree<DataType,NodeType>((b_tree<DataType,NodeType>&&)tree) {
				_wpl=tree._wpl;
				_ele=tree._ele;
			}
