	...
	namespace tree {
		namespace node {
			...
			struct random_access_child_storage{
				...
				random_access_child_storage(random_access_child_storage&& rhs) noexcept {
			...
			struct default_data_storage{
				...
				default_data_storage(default_data_storage&& rhs) noexcept {
			...
			struct B_child_storage:random_access_child_storage<NodeType,Size>{
				...
				explicit B_child_storage()= default;
				B_child_storage(const B_child_storage&)=delete;
				B_child_storage(B_child_storage&& rhs) noexcept:random_access_child_storage<NodeType,Size>(std::move(rhs)){}
			};
			...
			struct B_data_storage{
				...
				B_data_storage(B_data_storage&& rhs) noexcept {
					data=std::move(rhs.data);
				}
			};
